...
it('registers dataset page detail settings routes with the cms session-auth middleware stack', function (): void {
    $route = collect(Route::getRoutes()->getRoutes())
        ->first(fn ($route) => $route->uri() === 'api/cms/datasets/pages/{page}/detail-settings' && in_array('PUT', $route->methods(), true));
